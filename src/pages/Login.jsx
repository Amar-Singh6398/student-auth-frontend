        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          <AnimatePresence>
            {error && (
              ...
              >
                <div className="shrink-0 w-1.5 h-1.5 rounded-full bg-destructive" />
                {error}
              </motion.div>
            )}
          </AnimatePresence>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link to="/forgot-password" size="sm" className="text-primary font-semibold hover:underline decoration-2 underline-offset-4">
              Forgot Password?
            </Link>
          </div>
